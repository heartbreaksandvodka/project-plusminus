...
from .api_views.mt5_verification_views import test_mt5_connection, refresh_account_status, get_mt5_setup_status
...
urlpatterns = [
    ...
    path('setup-status/', get_mt5_setup_status, name='get_mt5_setup_status'),
